...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="/">
		<xsl:variable name="dc-json-in-xml-v0">
			<xsl:call-template name="dc-xml-v0">
				<xsl:with-param name="resource" select="$root-resource" />
			</xsl:call-template>
		</xsl:variable>
		<xsl:copy-of select="$dc-json-in-xml-v0" />
	</xsl:template>

	<xsl:template name="dc-xml-v0">
		<xsl:param name="resource" required="true" />
		<map>

			<!-- COMMON FIELDS -->

			<xsl:call-template name="id-dc-v0" />
			<xsl:call-template name="type-dc-v0" />
			<xsl:call-template name="additional-type-dc-v0" />
			<xsl:call-template name="title-dc-v0" />

			<!-- OBJECT FIELDS -->

			<xsl:call-template name="collection-dc-v0" />
			<xsl:call-template name="accession-number-dc-v0" />
			<xsl:call-template name="materials-dc-v0" />
			<xsl:call-template name="dimensions-dc-v0" />
			<xsl:call-template name="content-description-dc-v0" />
			<xsl:call-template name="physical-description-dc-v0" />
			<xsl:call-template name="significance-statement-dc-v0" />
			<xsl:call-template name="educational-significance-dc-v0" />
			<xsl:call-template name="creator-dc-v0" />
			<xsl:call-template name="contributor-dc-v0" />
			<xsl:call-template name="spatial-dc-v0" />
			<xsl:call-template name="temporal-dc-v0" />
			<!-- TODO: all assoc are 'in presence of' so dates and places are coming thru, need to add AAT or something into CRM -->
			<xsl:call-template name="acknowledgement-dc-v0" />
			<xsl:call-template name="inwardloan-dc-v0" />
			<xsl:call-template name="exhibition-location-dc-v0" />
			<xsl:call-template name="object-parent-dc-v0" />
			<xsl:call-template name="object-children-dc-v0" />
			<xsl:call-template name="related-dc-v0" />
			<xsl:call-template name="media-parent-dc-v0" />
			<xsl:call-template name="web-links-dc-v0" />
			...
			<xsl:call-template name="representations-dc-v0" />
			
			<!-- PARTY FIELDS -->
			<xsl:call-template name="full-name-dc-v0" />
			<xsl:call-template name="first-name-dc-v0" />
			<xsl:call-template name="middle-name-dc-v0" />
			<xsl:call-template name="last-name-dc-v0" />
			<xsl:call-template name="other-name-dc-v0" />
			<xsl:call-template name="gender-dc-v0" />

			<!-- PLACE FIELDS -->
			<xsl:call-template name="location-dc-v0" />

			<!-- NARRATIVE FIELDS -->
			<!-- TODO: narrative author, audience, media, des-type -->
			<xsl:call-template name="narrative-text-dc-v0" />
			<xsl:call-template name="narrative-image-dc-v0" />
			<xsl:call-template name="narrative-parent-dc-v0" />
			<xsl:call-template name="narrative-children-dc-v0" />
			<xsl:call-template name="narrative-objects-dc-v0" />

			<!-- COMMON FIELDS (footer) -->

			<xsl:call-template name="record-metadata-dc-v0" />
	...
	<xsl:template name="record-metadata-dc-v0">
	...
	<!-- collection -->
	<xsl:template name="collection-dc-v0">
	...
	<!-- accession number -->
	<xsl:template name="accession-number-dc-v0">
		<!-- accession number -->
	...
	<xsl:template name="materials-dc-v0">
	...
	<!-- dimensions -->
	<xsl:template name="dimensions-dc-v0">
	...
	<!-- content description -->
	<xsl:template name="content-description-dc-v0">
	...
	<xsl:template name="physical-description-dc-v0">
	...
	<xsl:template name="significance-statement-dc-v0">
	...
	<xsl:template name="educational-significance-dc-v0">
	...
	<!-- production parties -->
	<xsl:template name="creator-dc-v0">
	...
	<!-- associated parties -->
	<xsl:template name="contributor-dc-v0">
	...
	<xsl:template name="spatial-dc-v0">
	...
	<xsl:template name="temporal-dc-v0">
	...
	<!-- acknowledgement -->
	<xsl:template name="acknowledgement-dc-v0">
	...
	<!-- inward loan -->
	<xsl:template name="inwardloan-dc-v0">
		<xsl:if test="
	...
	<!-- exhibition location -->
	<xsl:template name="exhibition-location-dc-v0">
	...
	<!-- parent object -->
	<xsl:template name="object-parent-dc-v0">
		<xsl:variable name="value" select="
	...
	<!-- children objects -->
	<xsl:template name="object-children-dc-v0">
		<xsl:variable name="value" select="
	...
	<!-- related -->
	<xsl:template name="related-dc-v0">
	...
	<xsl:template name="media-parent-dc-v0">
	...
	<!-- web links -->
	<xsl:template name="web-links-dc-v0">
		<xsl:variable name="value" select="
	...
	<xsl:template name="representations-dc-v0">
	...
	<!-- full name -->
	<xsl:template name="full-name-dc-v0">
	...
	<!-- first name -->
	<xsl:template name="first-name-dc-v0">
	...
	<!-- middle name -->
	<xsl:template name="middle-name-dc-v0">
		<xsl:copy-of
	...
	<!-- last name -->
	<xsl:template name="last-name-dc-v0">
	...
	<!-- other names -->
	<xsl:template name="other-name-dc-v0">
	...
	<!-- gender -->
	<xsl:template name="gender-dc-v0">
	...
	<!-- location -->
	<xsl:template name="location-dc-v0">
	...
	<!-- narrative text -->
	<xsl:template name="narrative-text-dc-v0">
	...
	<xsl:template name="narrative-image-dc-v0">
		<xsl:variable name="value" select="
			path:forward('ore:aggregates')[
	...
	<!-- parent narrative -->
	<xsl:template name="narrative-parent-dc-v0">
		<xsl:variable name="value" select="
	...
	<!-- children narratives -->
	<xsl:template name="narrative-children-dc-v0">
		<xsl:variable name="value" select="
			path:forward('ore:aggregates')[
				path:forward(., 'rdf:type') = 'http://www.openarchives.org/ore/terms/Aggregation'
			]
	...
	<xsl:template name="narrative-objects-dc-v0">
		<xsl:variable name="value" select="
			path:forward('ore:aggregates')[
				path:forward(., 'rdf:type') = 'http://www.cidoc-crm.org/cidoc-crm/E19_Physical_Object'
			]
